...
var config string B227_NGSecret;
var config bool B227_ngSecretSet;
...
function Created()
{
	...
	SecretCombo.AddItem(B227_NGSecret);
...
function Close(optional bool bByParent)
{
	...
	B227_NGSecret = SecretCombo.GetValue();
	//-GetPlayerOwner().ngSecretSet = True;
	B227_ngSecretSet = true;
...
function OKPressed()
{
	...
	if (SecretCombo.GetValue() == B227_NGSecret)
		Close();
...
function MessageBoxDone(UWindowMessageBox W, MessageBoxResult Result)
{
	if(W == ConfirmChange)
	{
		...
		case MR_No:
			...
			SecretCombo.SetValue(B227_NGSecret);
			break;
		}
	}
}
