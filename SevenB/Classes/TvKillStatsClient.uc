...
var string WeaponDamages[12]; //inv group. #10=pulse
var string WeaponTimes[12];  //inv group. #10=pulse
var string Weapons[11];

function Created(){
  Super.Created();
  Weapons[1]=class'DispersionPistol'.default.ItemName;
  Weapons[2]=class'SevenMachineMag'.default.ItemName;
  Weapons[4]=class'ShockRifle'.default.ItemName;
  Weapons[6]=class'SevenSniperRifle'.default.ItemName;
  Weapons[5]=class'SBquadshot'.default.ItemName;
  Weapons[0]=class'SevenCarRifle'.default.ItemName;
  Weapons[3]=class'SevenChaingun'.default.ItemName;
  Weapons[9]=class'TVEightball'.default.ItemName;
  Weapons[8]=class'SBFlechetteCannon'.default.ItemName;
  Weapons[10]=class'SevenPulsegun'.default.ItemName;
  Weapons[7]=class'SBBloodRipper'.default.ItemName;
...
//  DrawBodyCount("Gasbag", Gasbags, Canvas, row++);
  DrawBodyCount("Spinners", Krall, Canvas, row++);
//  DrawBodyCount("Sliths", Sliths, Canvas, row++);
  ...
  DrawBodyCount("Flies", Flies, Canvas, row++);
