...
{
     BiteDamage=20
     Die2=Sound'SevenB.Spinner.Die2'
     CarcassType=Class'SevenB.SpinnerCarcass'
     TimeBetweenAttacks=3.500000
     bHasRangedAttack=True
     bGreenBlood=True
     RangedProjectile=Class'SevenB.SpinnerProjectile'
     Acquire=Sound'SevenB.Spinner.threat1'
     Threaten=Sound'SevenB.Spinner.threat2'
     bCanStrafe=True
     MeleeRange=60.000000
     GroundSpeed=250.000000
     AccelRate=500.000000
     JumpZ=128.000000
     HitSound1=Sound'SevenB.Spinner.hurt1'
     HitSound2=Sound'SevenB.Spinner.hurt2'
     Die=Sound'SevenB.Spinner.Die1'
