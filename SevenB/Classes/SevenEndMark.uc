// ===============================================================
// SevenEndMark : This actor should exist only ONCE in Seven Bullets.  controls high score saving.
// Note: can warp or set cutscene.
// Event is triggered when player is doen with notification stuff.
// ===============================================================

class SevenEndMark expands Keypoint;
