class B227_XidiaFootStepManager expands FootStepManager;

#exec OBJ LOAD FILE="XidiaFootSteps.uax"
...
static function Sound GetFootStepSound(Texture T)
{
	switch (Caps(T.Name))
	{
		...
		case "WALLWKD":
		case "BS_1":
			return Sound'XidiaFootSteps.FS_METAL_1';
		case "SHFLOOR01":
		case "GROUND1":
		case "DMGROUND1":
		case "MORTER1":
		...
		case "ABASIC4":
		case "DMGRAS2":
			return Sound'XidiaFootSteps.FS_GRAVEL_1';
		case "DMGRA":
		case "EZGRASS":
		case "DMGRAS":
		case "GRASS":
			return Sound'XidiaFootSteps.FS_GRASS_1';
		case "QBS2":
		case "SCARPET3":
		case "GCLTH2":
		case "GCLTH3":
		...
		case "RUG-REND":
		case "RUG-RUG":
			return Sound'XidiaFootSteps.FS_STUFF_1';
		case "OQ_WL2":
		case "MUD2":
			return Sound'XidiaFootSteps.FS_MUD_1';
		case "AA_BS":
		case "JEBWLG1":
		case "JEBWLG2":
		case "T-GRATE":
		...
		case "HULLRIB1":
		case "SLOTTED3":
			return Sound'XidiaFootSteps.FS_METAL2_1';
		case "WOOD1":
		case "WOOD2A":
		case "T-WOOD":
		case "T-WOOD2":
		...
		case "COBBLE2":
		case "CONCRETEBASE":
			return Sound'XidiaFootSteps.FS_CONCRETE_1';
		case "PAVEBASE":
		case "SANDMRTR2":
			return Sound'XidiaFootSteps.FS_SAND_1';
		case "AZ-FLOOR":
		case "FLOOR1":
		case "FLOOR2":
		case "FLOOR2B":
		...
		case "SFLOORC3":
		case "SFLOORC4":
			return Sound'XidiaFootSteps.fs_stein_1';
	}
	return none;
}
...
defaultproperties
{
	FootStepSound_OnWood=Sound'XidiaFootSteps.FS_ON-WOOD_1'
}
