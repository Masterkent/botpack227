...
//bleaveonscreen=true;
  bSizable = False;
  Box=MessageBox("WARNING","Seven Bullets has detected that Decals are disabled.  Not only are decals a critical part"$" of a Single Player experience, but if decals are disabled, you will NOT be able to HEAR DYNAMIC foot step sounds!\\nEnable Decals?\\n Note: This message will not appear again.", MB_YesNo, MR_No, MR_None);
