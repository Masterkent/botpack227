...
DedicatedButton = UWindowSmallButton(CreateControl(class'UWindowSmallButton', WinWidth-156, WinHeight-24, 48, 16));
  DedicatedButton.SetText(class'UMenu.UMenuStartGameClientWindow'.default.DedicatedText);
  DedicatedButton.SetHelpText(class'UMenu.UMenuStartGameClientWindow'.default.DedicatedHelp);
...
Pages = UMenuPageControl(CreateWindow(class'UMenuPageControl', 0, 0, WinWidth, WinHeight));
  ...
  ServerTab = Pages.AddPage(class'UMenu.UMenuStartGameClientWindow'.default.ServerText, class'UMenu.UMenuServerSetupSC');
}
function Resized()
{
