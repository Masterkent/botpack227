...
var globalconfig bool SpTaunts;   //taunts/headshots?
var globalconfig bool Pause; //load save as pausing?
...
function RegisterDamageMutator(UTC_Mutator M) //never change OSA 3 SP oldskool as top mutator.
{
    class'UTC_GameInfo'.static.UTSF_RegisterDamageMutator(M);
  /*-
...
function Killed(pawn killer, pawn Other, name damageType)
{
  ...
  bAutoTaunt = (SPTaunts && TournamentPlayer(Killer) != none);     //stupid auto taunting
  if (bAutoTaunt
...
defaultproperties
{
     ...
     ScoreBoardType=Class'OldSkool.OldSkoolScoreBoard'
