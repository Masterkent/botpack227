...
function Created()
{
  ...
  item1 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 10, 210, 1));
  ...
  item2 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 28, 210, 1));
  ...
  item3 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 46, 210, 1));
  item3.SetText("Change ASMD into ShockRifle");
  item3.SetFont(F_Normal);
  item3.Align = TA_Left;
  item3.bChecked = class'Oldskool.spoldskool'.default.bASMD;

  item4 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 64, 210, 1));
  ...
  item5 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10,82, 210, 1));
  ...
  item6 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10,98, 210, 1));
  item6.SetText("UT minigun");
  item6.SetFont(F_Normal);
  item6.Align = TA_Left;
  item6.bChecked = class'Oldskool.spoldskool'.default.bmini;

  item7 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 116, 210, 1));
  ...
  item8 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 134, 210, 1));
  ...
  item9 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 152, 210, 1));
  item9.SetText("UT Sniper Rifle");
  item9.SetFont(F_Normal);
  item9.Align = TA_Left;
  item9.bChecked = class'Oldskool.spoldskool'.default.bRifle;

  item13 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 170, 210, 1));
...
item14 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 188, 210, 1));
...
item15 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 206, 210, 1));
...
item16 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 224, 210, 1));
...
item17 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 242, 210, 1));
...
item19 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10,260, 210, 1));
...
item21 = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10,278, 210, 1));
...
SpTaunt = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 296, 210, 1));
...
Pause = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 314, 210, 1));
...
AirCon = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 332, 210, 1));
...
PermaCarc = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 350, 210, 1));
...
PermaDec = UWindowCheckBox(CreateControl(class'UWindowCheckBox', ControlXOffset + 10, 368, 210, 1));
