...
function SetStats (string Num,bool esca){
  TvKillStatsClient(UWindowScrollingDialogClient(ClientArea).ClientArea).SetStats(Num,esca);
}

defaultproperties
{
     ClientClass=Class'XidiaMPack.TVKillStatsScroller'
