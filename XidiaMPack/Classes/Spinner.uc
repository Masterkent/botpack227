...
{
     BiteDamage=20
     Die2=Sound'XidiaMPack.Spinner.Die2'
     CarcassType=Class'XidiaMPack.SpinnerCarcass'
     TimeBetweenAttacks=3.500000
     bHasRangedAttack=True
     bGreenBlood=True
     RangedProjectile=Class'XidiaMPack.SpinnerProjectile'
     Acquire=Sound'XidiaMPack.Spinner.threat1'
     Threaten=Sound'XidiaMPack.Spinner.threat2'
     bCanStrafe=True
     MeleeRange=60.000000
     GroundSpeed=250.000000
     AccelRate=500.000000
     JumpZ=128.000000
     HitSound1=Sound'XidiaMPack.Spinner.hurt1'
     HitSound2=Sound'XidiaMPack.Spinner.hurt2'
     Die=Sound'XidiaMPack.Spinner.Die1'
