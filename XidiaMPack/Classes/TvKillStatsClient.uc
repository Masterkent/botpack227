...
function Created(){
  Super.Created();
  Weapons[1]=class'Chainsaw'.default.ItemName;
  Weapons[2]=class'DispersionPistol'.default.ItemName;
  Weapons[3]=class'automag'.default.ItemName;
  Weapons[4]=class'ShockRifle'.default.ItemName;
  Weapons[5]="Mining Tool";
  Weapons[6]=class'SniperRifle'.default.ItemName;
  Weapons[7]=class'pulsegun'.default.ItemName;
  Weapons[8]=class'UT_Flakcannon'.default.ItemName;
  Weapons[9]=class'eightball'.default.ItemName;
  Weapons[0]=class'xidiaminigun2'.default.ItemName;
}
...
function SetStats (string Info, bool esca){
  local int i, pos;
  if (!esca){
    Weapons[1]=class'ut_biorifle'.default.ItemName;
    Weapons[7]=class'ripper'.default.ItemName;
    Weapons[0]=class'xidiacarrifle'.default.ItemName;
  }
  pos=-1;
  CutInfo(Info,pos);
...
function Paint(Canvas Canvas, float X, float Y)
{
  ...
  DrawBodyCount("Skaarj Hybrids", Mercs, Canvas, row++);
