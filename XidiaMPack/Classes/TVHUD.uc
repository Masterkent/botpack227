...
simulated function HudSetup (Canvas Canvas){
  ...
  if (tvplayer(owner).linfo!=none && !tvplayer(owner).linfo.bIsMissionPack){ //dif icons in gold
    WeapIcons[0]=Texture'CARifleF';
    WeapIcons[10]=Texture'CARifleE';
    WeapIcons[20]=Texture'CARifleN';
    WeapIcons[1]=Texture'bioF';
    ...
    WeapIcons[0]=default.WeapIcons[0];
    WeapIcons[10]=default.WeapIcons[10];
    WeapIcons[20]=default.WeapIcons[20];
    WeapIcons[1]=default.WeapIcons[1];
    WeapIcons[11]=default.WeapIcons[11];
    WeapIcons[21]=default.WeapIcons[21];
    WeapIcons[7]=default.WeapIcons[7];
    WeapIcons[17]=default.WeapIcons[17];
    WeapIcons[27]=default.WeapIcons[27];
  }
...
function SetINvGroup(Inventory W)
{
	...
	if (W.IsA('ChainSaw'))
		...
		W.InventoryGroup = 2;
	else if (W.IsA('XidiaAutomag'))
		W.InventoryGroup = 3;
	else if (W.IsA('olStinger'))
		W.InventoryGroup = 5;
	else if (W.IsA('XidiaSniperRifle'))
		W.InventoryGroup = 6;
	else if (W.IsA('TVPulseGun') || W.IsA('Ripper'))
		W.InventoryGroup = 7;
	else if (W.IsA('ut_flakcannon'))
		W.InventoryGroup = 8;
	else if (W.IsA('olEightball'))
		W.InventoryGroup = 9;
	else if (W.IsA('XidiaCarRifle'))
		W.InventoryGroup = 10;
	else if (W.IsA('XidiaMinigun2'))
		W.InventoryGroup = 10;
}
...
simulated function DrawAmmo(Canvas Canvas, int X, int Y)
{
  ...
  Canvas.DrawRect(Texture'AmmoCount',M335,240*scale*weapMult);
  if (PawnOwner.Weapon==none)
    return;
  ...
  if (PawnOwner.Weapon.IsA('xidiacarrifle')&&XidiaCarRifle(PawnOwner.Weapon).bUseAlt){
...
simulated function DrawCrossHair( canvas Canvas, int StartX, int StartY )
{
  ...
  //    if (Hit.IsA('MercCarcass')||Hit.IsA('HumanCarcass')) //considered combatent ally
   //     Canvas.DrawColor = CyanColor;
    ...
    Canvas.DrawColor = WhiteColor;
  else if (Hit.Isa('playerpawn'))  //combatent allies
    Canvas.DrawColor = CyanColor;
...
defaultproperties
{
     ...
     WeapIcons(0)=Texture'XidiaMPack.Icons.miniF'
     WeapIcons(1)=Texture'XidiaMPack.Icons.ChainsawF'
     WeapIcons(2)=Texture'XidiaMPack.Icons.DPistolF'
     WeapIcons(3)=Texture'XidiaMPack.Icons.AutoMagF'
     WeapIcons(4)=Texture'XidiaMPack.Icons.asmdF'
     WeapIcons(5)=Texture'XidiaMPack.Icons.stingF'
     WeapIcons(6)=Texture'XidiaMPack.Icons.sniperF'
     WeapIcons(7)=Texture'XidiaMPack.Icons.pulseF'
     WeapIcons(8)=Texture'XidiaMPack.Icons.FlakF'
     WeapIcons(9)=Texture'XidiaMPack.Icons.EballF'
     WeapIcons(10)=Texture'XidiaMPack.Icons.miniE'
     WeapIcons(11)=Texture'XidiaMPack.Icons.ChainsawF'
     WeapIcons(12)=Texture'XidiaMPack.Icons.DPistolE'
     WeapIcons(13)=Texture'XidiaMPack.Icons.AutoMagE'
     WeapIcons(14)=Texture'XidiaMPack.Icons.asmdE'
     WeapIcons(15)=Texture'XidiaMPack.Icons.stingE'
     WeapIcons(16)=Texture'XidiaMPack.Icons.sniperE'
     WeapIcons(17)=Texture'XidiaMPack.Icons.pulseE'
     WeapIcons(18)=Texture'XidiaMPack.Icons.FlakE'
     WeapIcons(19)=Texture'XidiaMPack.Icons.EballE'
     WeapIcons(20)=Texture'XidiaMPack.Icons.miniN'
     WeapIcons(21)=Texture'XidiaMPack.Icons.ChainsawN'
     WeapIcons(22)=Texture'XidiaMPack.Icons.DPistolN'
     WeapIcons(23)=Texture'XidiaMPack.Icons.AutoMagN'
     WeapIcons(24)=Texture'XidiaMPack.Icons.asmdN'
     WeapIcons(25)=Texture'XidiaMPack.Icons.stingN'
     WeapIcons(26)=Texture'XidiaMPack.Icons.sniperN'
     WeapIcons(27)=Texture'XidiaMPack.Icons.pulseN'
     WeapIcons(28)=Texture'XidiaMPack.Icons.FlakN'
     WeapIcons(29)=Texture'XidiaMPack.Icons.EballN'
     HUDConfigWindowType="XidiaMPack.tvhudconfig"
     Texture=None
