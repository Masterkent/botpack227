...
class NCOptionsClientWindow extends UWindowDialogClientWindow
	config;
...
function Created()
{
	...
	Pages.AddPage(GamePlayTab, class'NCGameOptionsScrollClient');
	Pages.AddPage(ControlsTab, class'NCCustomizeScrollClient');
	Pages.AddPage(InputTab, class'UMenuInputOptionsScrollClient');
	Pages.AddPage(HUDTab, class'NCHUDConfigScrollClient');
