...
class NCCustomizeClientWindow extends UMenuPageWindow;
...
defaultproperties
{
     ...
     LabelList(20)="Previous Weapon"
     LabelList(21)="Throw Weapon"
     LabelList(22)="Skip Event"
     LabelList(23)="Add Quick-Spell"
     LabelList(24)="Next Quick-Spell"
     LabelList(25)="Previous Quick-Spell"
     LabelList(26)="Select Spell"
     LabelList(27)="Next Spell"
     LabelList(28)="Previous Spell"
     LabelList(29)="Next Book"
     LabelList(30)="Previous Book"
     AliasNames(0)="Fire"
     ...
     AliasNames(20)="PrevWeapon"
     AliasNames(21)="ThrowWeapon"
     AliasNames(22)="skipKeyDwn"
     AliasNames(23)="SetQuickSpell"
     AliasNames(24)="NextQuickSpell"
     AliasNames(25)="PrevQuickSpell"
     AliasNames(26)="SelectSpell"
     AliasNames(27)="NextSpell"
     AliasNames(28)="PrevSpell"
     AliasNames(29)="NextBook"
     AliasNames(30)="PrevBook"
     OrString=" or "
