...
// PKShellCase.
//=============================================================================
class PKShellCase extends Projectile;
...
function MakeSound()
{
	if (FRand() < 0.5) PlaySound(sound'PKmgshell1',, 0.4+0.4 * FRand(),,,0.9+0.2*FRand());
	else PlaySound(sound'PKmgshell2',, 0.4+0.4 * FRand(),,,0.9+0.2*FRand());
}
...
defaultproperties
{
     ...
     LifeSpan=3.000000
     Skin=Texture'PerUnreal.Skins.PKMGShell'
