...
#exec OBJ LOAD FILE="Male1Voice.uax"
...
defaultproperties
{
	NameSound(0)=Sound'Male1Voice.M1redleader'
	NameSound(1)=Sound'Male1Voice.M1blueleader'
	NameSound(2)=Sound'Male1Voice.M1greenleader'
	NameSound(3)=Sound'Male1Voice.M1goldleader'
	NameTime(0)=0.960000
	NameTime(1)=1.100000
	NameTime(2)=1.020000
	NameTime(3)=0.990000
	AckSound(0)=Sound'Male1Voice.M1gotit'
	AckSound(1)=Sound'Male1Voice.M1roger'
	AckSound(2)=Sound'Male1Voice.M1onmyway'
	AckSound(3)=Sound'Male1Voice.M1imonit'
	AckString(0)="Got it"
	AckString(1)="Roger"
	...
	AckTime(3)=0.980000
	numAcks=4
	FFireSound(0)=Sound'Male1Voice.M1sameteam'
	FFireSound(1)=Sound'Male1Voice.M1idiot'
	FFireString(0)="Hey! Same team!"
	FFireString(1)="I'm on your team, you idiot!"
	FFireAbbrev(1)="On your team!"
	numFFires=2
	TauntSound(0)=Sound'Male1Voice.M1eatthat'
	TauntSound(1)=Sound'Male1Voice.M1likethat'
	TauntSound(2)=Sound'Male1Voice.M1yeahbitch'
	TauntSound(3)=Sound'Male1Voice.M1boom'
	TauntSound(4)=Sound'Male1Voice.M1burnbaby'
	TauntSound(5)=Sound'Male1Voice.M1letsrock'
	TauntSound(6)=Sound'Male1Voice.M1diebitch'
	TauntSound(7)=Sound'Male1Voice.M1loser'
	TauntSound(8)=Sound'Male1Voice.M1nailedem'
	TauntSound(9)=Sound'Male1Voice.M1nasty'
	TauntSound(10)=Sound'Male1Voice.M1nice'
	TauntSound(11)=Sound'Male1Voice.M1ohyeah'
	TauntSound(12)=Sound'Male1Voice.M1slaughter'
	TauntSound(13)=Sound'Male1Voice.M1sucker'
	TauntSound(14)=Sound'Male1Voice.M1yeehaw'
	TauntSound(15)=Sound'Male1Voice.M1yousuck'
	...
	MatureTaunt(2)=1
	MatureTaunt(6)=1
	OrderSound(0)=Sound'Male1Voice.M1defend'
	OrderSound(1)=Sound'Male1Voice.M1hold'
	OrderSound(2)=Sound'Male1Voice.M1assault'
	OrderSound(3)=Sound'Male1Voice.M1coverme'
	OrderSound(4)=Sound'Male1Voice.M1engage'
	OrderSound(10)=Sound'Male1Voice.M1takeflag'
	OrderSound(11)=Sound'Male1Voice.M1searchdestroy'
	...
	OtherSound(0)=Sound'Male1Voice.M1uncovered'
	OtherSound(1)=Sound'Male1Voice.M1getflagback'
	OtherSound(2)=Sound'Male1Voice.M1igotflag'
	OtherSound(3)=Sound'Male1Voice.M1gotyourback'
	OtherSound(4)=Sound'Male1Voice.M1imhit'
	OtherSound(6)=Sound'Male1Voice.M1underattack'
	OtherSound(7)=Sound'Male1Voice.M1yougotpoint'
	OtherSound(8)=Sound'Male1Voice.M1igotflag'
	OtherSound(9)=Sound'Male1Voice.M1inposition'
	OtherSound(10)=Sound'Male1Voice.M1onmyway'
	OtherSound(11)=Sound'Male1Voice.M1pointsecure'
	OtherSound(12)=Sound'Male1Voice.M1enemycarrier'
	OtherSound(13)=Sound'Male1Voice.M1backup'
	OtherSound(14)=Sound'Male1Voice.M1takedown'
	OtherSound(15)=Sound'Male1Voice.M1gotyoucovered'
	OtherSound(16)=Sound'Male1Voice.M1objectdestroy'
