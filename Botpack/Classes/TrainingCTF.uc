...
function TutorialSound( string NewSound )
{
	...
	class'UTC_Actor'.static.B227_PlayVoice(Trainee, MySound, 2.0);
}
...
function CTFTutEvent0()
{
	...
	class'TournamentConsole'.static.UTSF_ShowMessage(Trainee.Player.Console);
	TutorialSound(CTF[0]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[0]);
	SoundIndex++;
...
{
	TutorialSound(CTF[1]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[1]);
	SoundIndex++;
}
...
{
	TutorialSound(CTF[2]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[2]);
	SoundIndex++;
}
...
{
	TutorialSound(CTF[3]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[3]);
	SoundIndex++;
}
...
function CTFTutEvent4()
{
	...
	TutorialSound(CTF[4]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[4]);
	SoundIndex++;
}
...
{
	TutorialSound(CTF[5]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[5]);
	SoundIndex++;
}
...
{
	TutorialSound(CTF[6]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[6]);
	SoundIndex++;
}
...
function CTFTutEvent7()
{
	...
	TutorialSound(CTF[7]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[7]);
	SoundIndex++;
}
...
{
	TutorialSound(CTF[8]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[8]);
	SoundIndex++;
}
...
{
	TutorialSound(CTF[9]);
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[9]);
	SoundIndex++;
}
...
function CTFTutEvent11()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[11]);
	SoundIndex++;
}
...
function CTFTutEvent12()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[12]);
	SoundIndex++;
}
...
function CTFTutEvent13()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[13]);
	SoundIndex++;
}
...
function CTFTutEvent14()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[14]);
	SoundIndex++;
}
...
function CTFTutEvent15()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[15]);
	SoundIndex++;
}
...
function CTFTutEvent16()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[16]);
	SoundIndex++;
}
...
function CTFTutEvent17()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[17]);
	SoundIndex++;
...
state FreeRunning1
{
	function Tick(float DeltaTime)
	{
		...
		if (Trainee.PlayerReplicationInfo.HasFlag != None) 
		{
			...
			class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[18]);
			SoundIndex++;
...
function CTFTutEvent18()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[19]);
	SoundIndex++;
}
...
function CTFTutEvent19()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[20]);
	SoundIndex++;
...
state FreeRunning2
{
	function Tick(float DeltaTime)
	{
		...
		if (Teams[Trainee.PlayerReplicationInfo.Team].Score > 0) 
		{
			...
			class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[21]);
			SoundIndex++;
...
function CTFTutEvent20()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[22]);
	SoundIndex++;
}
...
function CTFTutEvent21()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[23]);
	SoundIndex++;
}
...
function CTFTutEvent22()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[24]);
	SoundIndex++;
}
...
function CTFTutEvent23()
{
	...
	class'TournamentConsole'.static.UTSF_AddMessage(Trainee.Player.Console, TutMessage[25]);
	SoundIndex++;
}
...
function EndGame( string Reason )
{
	...
	if (SuccessfulGame())
		...
		class'UTC_PlayerPawn'.static.B227_ClientPlayVoice(Trainee, sound'Announcer.LostMatch', True);
