...
//=============================================================================
class TournamentGameReplicationInfo extends UTC_GameReplicationInfo;
...
simulated function string GetOrderString(PlayerReplicationInfo PRI)
{
	...
	if ( BRI == None )
	{
		if (PRI.bIsSpectator && (UTC_PlayerReplicationInfo(PRI) == none || !UTC_PlayerReplicationInfo(PRI).bWaitingPlayer ))
