...
function DrawContactInfo( canvas C, TournamentGameReplicationInfo GRI )
{
...
function DrawMOTD( canvas C, TournamentGameReplicationInfo GRI )
{
	local float XL, YL, XL2, YL2;
...
function DrawShortContactInfo( canvas C, TournamentGameReplicationInfo GRI )
{
	local float XL, YL, XL2, YL2;
...
function DrawShortMOTD( canvas C, TournamentGameReplicationInfo GRI )
{
	local float XL, YL, XL2, YL2;
