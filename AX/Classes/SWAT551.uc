...
// SWAT551.
//=============================================================================
class SWAT551 expands AXweapons;
   ...
   if ( (Other != self) && (Other != Owner) && (Other != None) )
	{
		...
		if ( Other.bIsPawn && (HitLocation.Z - Other.Location.Z > 0.62 * Other.CollisionHeight)
			...
			Other.TakeDamage(40, Pawn(Owner), HitLocation, 35000 * X, myDamageType);
		else
			Other.TakeDamage(14,  Pawn(Owner), HitLocation, 30000.0*X, MyDamageType);
...
defaultproperties
{
     ...
     FireOffset=(X=5.500000,Y=-5.000000,Z=-6.250000)
     MyDamageType=shot
     AltDamageType=Decapitated
     AIRating=0.630000
     FireSound=Sound'AX.Sounds.SWATfire'
     ...
     PickupMessage="You got the SIG SWAT551"
     ItemName="SIG SWAT 551"
     PlayerViewOffset=(X=6.500000,Y=-2.820000,Z=-6.500000)
     PlayerViewMesh=LodMesh'AX.SWAT551'
     PlayerViewScale=0.180000
     BobDamping=0.975000
     PickupViewMesh=LodMesh'AX.SWAT551pickup'
     PickupViewScale=0.730000
     ThirdPersonMesh=LodMesh'AX.SWAT5513rd'
     ThirdPersonScale=0.600000
     StatusIcon=Texture'AX.Icons.useSWAT551'
     ...
     Icon=Texture'AX.Icons.useSWAT551'
     Physics=PHYS_Falling
     Mesh=LodMesh'AX.SWAT5513rd'
     bNoSmooth=False
