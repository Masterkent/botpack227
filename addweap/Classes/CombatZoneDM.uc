...
//
//=============================================================================
class CombatZoneDM extends DeathMatchPlus;
...
function bool RestartPlayer( pawn aPlayer )
{
	...
	bResult = Super(TournamentGameinfo).RestartPlayer(aPlayer);
...
defaultproperties
{
     DefaultPlayerClass=Class'addweap.ADTFemale1'
     HUDType=Class'addweap.ADHUD'
     GameName="CombatZone DeathMatch"
