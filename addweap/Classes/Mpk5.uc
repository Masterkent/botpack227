...
//#exec TEXTURE IMPORT NAME=Tmpk4 FILE=textures\ruka.PCX GROUP=Skins FLAGS=2
...
function setHand(float Hand)
{
	Super.SetHand(Hand);
	if ( Hand == 1 )
		Mesh = mesh(DynamicLoadObject("addweap.mpkL", class'Mesh'));
	else
		Mesh = mesh'mpk';
}
...
Begin:
	...
	bSteadyFlash3rd = False;
	if (Ammotype.ammoamount <= 29) AClipCount = Ammotype.ammoamount;
	else AClipCount = 30;
...
defaultproperties
{
     ShotAccuracyBase=0.500000
     LegDamage=9
     HeadDamage=16
     ArmorDamage=15
     WeaponDescription="Classification: MP5K Submachine gun"
     AmmoName=Class'addweap.MpkAmmo'
     PickupAmmoCount=20
     bInstantHit=True
     bRapidFire=True
     ...
     FireSound=Sound'addweap.mpk.mpkFire'
     ...
     PickupMessage="You got H&K MP5K."
     ItemName="mp5K"
     PlayerViewOffset=(X=9.400000,Y=-5.600000,Z=-4.000000)
     PlayerViewMesh=LodMesh'addweap.mpk'
     PlayerViewScale=0.900000
     BobDamping=0.975000
     PickupViewMesh=LodMesh'addweap.mpkPick'
     PickupViewScale=1.300000
     ThirdPersonMesh=LodMesh'addweap.mpkHand'
     StatusIcon=Texture'Botpack.Icons.UseRifle'
     bMuzzleFlashParticles=True
     MuzzleFlashStyle=STY_Translucent
     MuzzleFlashMesh=LodMesh'addweap.mpkmuzzle'
     MuzzleFlashScale=0.100000
     MuzzleFlashTexture=Texture'Botpack.Skins.Muzzy3'
     PickupSound=Sound'UnrealShare.Pickups.WeaponPickup'
     Icon=Texture'Botpack.Icons.UseRifle'
     Rotation=(Roll=-1536)
     Mesh=LodMesh'addweap.mpk'
     bNoSmooth=False
