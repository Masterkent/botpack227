...
// RebelSkaarjTrooper : A following skaarj trooper.
// ============================================================

class RebelSkaarjTrooper expands RebelSkaarj;
...
function bool CanFireAtEnemy()
{
  ...
  if ( Weapon.bInstantHit) //instant hit
