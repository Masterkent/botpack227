...
// FollowingKrall : Krall follower implemented in 1.3    Custom mappers where begging too much for him.
// ===============================================================

class FollowingKrall expands Follower;
...
var() byte bSleeping; //0=no, 1=sleep1, 2=sleep2, 3=sleep3
var   bool bHasDice;
var    bool bHeldDice;
...
{
  if ( Other.IsA('Krall')&&Other.enemy!=self) //befriend all nice mercs.
    return ATTITUDE_Friendly;
  return Super.AttitudeToCreature(Other);
}
function bool IsValidTarget(pawn apawn){ //nice to all mercs.
  if (Apawn.IsA('FollowingKrall')||Apawn.IsA('Krall'))
    return false;
...
function Carcass SpawnCarcass()
{
 ...
 /*     //Wiped: I'm not going to take the time to implement this ;p
...
defaultproperties
{
     ...
     bLeadTarget=False
     RangedProjectile=Class'oldskool.olKraalBolt'
