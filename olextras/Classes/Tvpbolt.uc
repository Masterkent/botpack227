    ...
    && ((Pawn(HitActor) == None) || Pawn(HitActor).AdjustHitLocation(HitLocation, X)) )
  {
    ...
    if (Level.NetMode != NM_DedicatedServer){
      ...
      if ( HitActor.bIsPawn )  //note: effect is still shown during reflection to mask out bolt anim sinc problems (I could hack around it, but too lazy)
      {
        ...
        WallEffect.Texture=Texture'olextras.BlueBoltCap.pEnd_a00';
  ...
  if ( BeamLength>=810 )
  {
    if (Level.NetMode != NM_DedicatedServer){
      if ( (WallEffect == None) || WallEffect.bDeleteMe ){
        ...
        WallEffect.Texture=Texture'olextras.BlueBoltHit.phit_a00';
        WallEffect.LightHue=170;
      }
      else if ( WallEffect.IsA('PlasmaHit') )
      {
...
defaultproperties
{
     SpriteAnim(0)=Texture'olextras.Skins.pbbolt0'
     SpriteAnim(1)=Texture'olextras.Skins.pbbolt1'
     SpriteAnim(2)=Texture'olextras.Skins.pbbolt2'
     SpriteAnim(3)=Texture'olextras.Skins.pbbolt3'
     SpriteAnim(4)=Texture'olextras.Skins.pbbolt4'
     Texture=Texture'olextras.Skins.pbbolt0'
     Skin=Texture'olextras.Skins.pbbolt0'
}
