// ============================================================
// olextras.tvCreditsWindow: This is actually a hack so that it will load the credits map.
// ============================================================
...
defaultproperties
{
     ClientClass=Class'olextras.TVCreditsCW'
     WindowTitle="Operation: Na Pali"
}
