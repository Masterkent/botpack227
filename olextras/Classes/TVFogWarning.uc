...
//bleaveonscreen=true;
  bSizable = False;
  Box=MessageBox("WARNING","Operation: Na Pali has detected that fog is disabled.  This mod places a high dependency on fog and for best gameplay/visuals, it is recommended that fog is enabled.\\nEnable fog?\\n Note: This message will not appear again.", MB_YesNo, MR_No, MR_None);
